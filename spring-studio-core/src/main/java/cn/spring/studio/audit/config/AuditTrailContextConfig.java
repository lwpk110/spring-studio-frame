package cn.spring.studio.audit.config;

import cn.spring.studio.audit.spi.AuditActionResolvers;
import cn.spring.studio.audit.spi.AuditResourceResolvers;
import cn.spring.studio.audit.spi.support.AnnotatedParamsAsStringResourceResolver;
